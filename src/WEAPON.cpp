...
{
  bool NormalShot = (Type.compare("Pistol") == 0 || Type.compare("Desert Eagle") == 0 || Type.compare("AK-47") == 0 || Type.compare("Elite AR") == 0  || Type.compare("car-SMG") == 0 || Type.compare("Sniper Rifle") == 0 || Type.compare("NP-9") == 0);
...
void WEAPON::setGunType()
{
  GunType = 
  {
    ...
    {"Elite AR", GunAttribute(4, 1, -10, 6, sf::Vector2f(22.f, -3.f), sf::Vector2f(11.f, 8.f), "../content/Gun/Sprite/Elite_AR.png", "../content/Gun/SFX/rifle_fire.wav")},
