...
ENEMY::ENEMY(std::string Type,  float init_Posi_x, float init_Posi_y)
{
    ...
    it = EnemyType.find(random_key->first);
    if (it != EnemyType.end())
    {
...
void  ENEMY::setEnemyType()
{
    EnemyType = 
  {
    ...
    {"Slinter", EnemyAttribute(4.f, 5.f, 100.f, std::string("Normal") ,std::string("../content/Sprite/Splinter.png"))}
  };
}
